...
export default function Hero() {
    return (
        <section className="flex items-start justify-start pt-28 px-4" style={{ minHeight: 'calc(100vh - 128px)' }}>
            ...
            {/* <p className="text-xl md:text-2xl text-foreground/80">
              ...
              {/* Bio Section - ADD THIS */}
                <div className="pt-0 text-left">
                    ...
                    <p className="text-[15px] md:text-lg text-textcolor mb-6 max-w-full md:max-w-xl">
                    ...
                    <p className="text-[15px] md:text-lg text-textcolor mb-6 max-w-full md:max-w-2xl">
                        You can find me{' '}
                        <RotatingText
                            phrases={[
